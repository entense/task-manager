...
use App\Components\Documentator\ServerSchema;
    ...
    'documentations' => [
        'default' => [
            'api' => [
                ...
                'version' => env('L5_SWAGGER_CONST_API_VERSION', '1.0'),

                'production_host' => env('L5_SWAGGER_CONST_PRODUCTION_HOST', env('APP_URL')) . '/api',

                'local_host' => env('L5_SWAGGER_CONST_LOCAL_HOST', null) . '/api',
            ],
